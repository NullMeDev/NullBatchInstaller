...
Write-Host "[MOCK] Starting installation of MockJetBrains"
...
if (4 -gt 0) {
    Write-Host "[MOCK] Simulating installation... (4 seconds)"
    Start-Sleep -Seconds 4
}

# Simulate registry write for successful installations
if (0 -eq 0) {
    $logPath = Join-Path $env:TEMP "MockJetBrains.bat.log"
